namespace Basic.Runtime
{
    ...
    {
        private readonly RunTimeEnvironment rte;
        ...
        /// </summary>
        /// <remarks>
        /// This method evaluates the line immeditaely if the <see cref="Line.Label"/> is <c>null</c> or empty.
        /// If you want a different strategy, you can override the <see cref="DoEvaluateImmediately(Line)"/> method in an inheritor class.
        /// </remarks>
        /// <param name="line">The parsed line.</param>
        /// <returns>The <see cref="EvaluateResult">result of the evaluating stage</see>.</returns>
        public virtual EvaluateResult Evaluate(Line line)
        {
        ...
        /// <summary>
        /// Detects whether evaluate the <see cref="Line.Statement">statement</see> immediately.
        /// </summary>
        /// <param name="line">The input line.</param>
        /// <returns><c>true</c> if the statement should be evaluated immeditely, otherwise, <c>false</c>.</returns>
        /// <remarks>
        /// This method takes a decision checking whether the <see cref="Line.Label"/> is <c>null</c> or empty.
        /// If you want a different strategy, you can override the method in an inheritor class.
        /// </remarks>
        protected internal virtual bool DoEvaluateImmediately(Line line)
        {
            if (line == null)
