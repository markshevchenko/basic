namespace Basic.Parsing
{
    ...
    {
        public static IStatement ReadStatementExcludingNext(this Scanner scanner)
        {
            IStatement result;
        ...
        public static bool TryReadStatementExcludingNext(this Scanner scanner, out IStatement result)
        {
        ...
        public static bool TryReadLet(this Scanner scanner, out IStatement result)
        {
            ILValue lValue;
        ...
        public static bool TryReadInput(this Scanner scanner, out IStatement result)
        {
        ...
        public static bool TryReadList(this Scanner scanner, out IStatement result)
        {
        ...
        public static bool TryReadRange(this Scanner scanner, out Range result)
        {
            string text;
        ...
        public static Range ReadRange(this Scanner scanner)
        {
            Range result;
        ...
        public static bool TryReadSave(this Scanner scanner, out IStatement result)
        {
        ...
        public static bool TryReadLoad(this Scanner scanner, out IStatement result)
        {
        ...
        public static bool TryReadRandomize(this Scanner scanner, out IStatement result)
        {
        ...
        public static bool TryReadIfThenElse(this Scanner scanner, out IStatement result)
        {
        ...
        public static bool TryReadDim(this Scanner scanner, out IStatement result)
        {
