namespace Basic.Tests.Parsing
{
    ...
    public class ScannerStatementExtensionsTests : BaseTests
    {
        ...
        {
            var scanner = new Scanner("LET a = 100");
            IStatement result;
        ...
        {
            var scanner = new Scanner("PRINT 3.14159265");
            IStatement result;
            var condition = scanner.TryReadLet(out result);
        ...
        {
            var scanner = new Scanner("LET result =");
            IStatement result;
            var condition = scanner.TryReadLet(out result);
        }
        ...
        {
            var scanner = new Scanner("INPUT var");
            IStatement result;
            var condition = scanner.TryReadInput(out result);
        ...
        {
            var scanner = new Scanner("INPUT \"prompt\", var");
            IStatement result;
            var condition = scanner.TryReadInput(out result);
        ...
        {
            var scanner = new Scanner("LIST 30-60");
            IStatement result;
        ...
        {
            var scanner = new Scanner("no range");
        ...
        {
            var scanner = new Scanner("REMOVE");
            IStatement result;
        ...
        {
            var scanner = new Scanner("REMOVE 100-200");
            IStatement result;
        ...
        {
            var scanner = new Scanner("SAVE \"very special program\"");
            IStatement result;
        ...
        {
            var scanner = new Scanner("GOTO 100");
            IStatement result;
        ...
        {
            var scanner = new Scanner("RANDOMIZE 314159265");
            IStatement result;
        ...
        {
            var scanner = new Scanner("RANDOMIZE");
            IStatement result;
        ...
        {
            var scanner = new Scanner("REM   non-EMPTY Comment");
            IStatement result;
        ...
        {
            var scanner = new Scanner("IF a <> 0 THEN PRINT a");
            IStatement result;
        ...
        {
            var scanner = new Scanner("IF a <> 0 THEN PRINT a ELSE INPUT a");
            IStatement result;
        ...
        {
            var scanner = new Scanner("IF a + b THEN PRINT a");
            IStatement result;
        ...
        {
            var scanner = new Scanner("IF a <> b PRINT a");
            IStatement result;
        ...
        {
            var scanner = new Scanner("IF a <> b THEN");
            IStatement result;
        ...
        {
            var scanner = new Scanner("IF a <> b THEN PRINT a ELSE");
            IStatement result;
        ...
        {
            var scanner = new Scanner("DIM 123");
            IStatement result;
        ...
        {
            var scanner = new Scanner("FOR I = 1 TO 10");
            IStatement result;
        ...
        {
            var scanner = new Scanner("FOR I = 10 TO 1 STEP -1");
            IStatement result;
        ...
        {
            var scanner = new Scanner("FOR I = 1 TO 10 PRINT I NEXT");
            IStatement result;
        ...
        {
            var scanner = new Scanner("FOR I = 1 TO 10 PRINT I");
            IStatement result;
        ...
        {
            var scanner = new Scanner("FOR = 1 TO 10 PRINT I NEXT");
            IStatement result;
        ...
        {
            var scanner = new Scanner("FOR I = TO 10 PRINT I NEXT");
            IStatement result;
        ...
        {
            var scanner = new Scanner("FOR I = 1 10 PRINT I NEXT");
            IStatement result;
        ...
        {
            var scanner = new Scanner("FOR I = 1 TO PRINT I NEXT");
            IStatement result;
        ...
        {
            var scanner = new Scanner("FOR I = 1 TO 10 NEXT");
            IStatement result;
